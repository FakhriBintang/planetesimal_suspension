...
%     figure(100);clf
    ...
    while resnorm/resnorm0 >= reltol && resnorm >= abstol && iter <= maxit
        ...
        if ~bnchm
            ...
            % plot(iter,log10(resnorm_TC),'xk','MarkerSize',15);
            % , ...
            %      iter,log10(normS)     ,'.r','MarkerSize',3, ...
            %      iter,log10(normXFe)   ,'or','MarkerSize',3, ...
            %      iter,log10(normXSi)   ,'ob','MarkerSize',3, ...
            %      iter,log10(normCFe)   ,'xr','MarkerSize',3, ...
            %      iter,log10(normCSi)   ,'xb','MarkerSize',3, ...
            %      iter,log10(normFFe)   ,'tr','MarkerSize',3, ...
            %      iter,log10(normFSi)   ,'tb','MarkerSize',3); box on; axis tight;
            drawnow;
        end
        iter = iter+1;
    end
