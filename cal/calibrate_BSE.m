...
Liquidcompupper = load('./McDonough_1995_1/Liquid_comp_upper.csv');   % output file of MELTS for upper phase loop
Solidcompupper  = load('./McDonough_1995_1/Solid_comp_upper.csv');   % output file of MELTS for upper phase loop
Bulkcompupper   = load('./McDonough_1995_1/Bulk_comp_upper.csv');   % output file of MELTS for upper phase loop
...
cphs0_bst  =  0.4083;               % phase diagram lower bound composition [wt SiO2]
...
perT_bst   =  1205;                % peritectic temperature [degC]
