...
T0      =  800+273.15;                                % reference/top potential temperature [k]
Ttop0   =  T0;                                      % isothermal top reference temperature 
T1      =  800+273.15;                                % bottom potential temperature (if different from top) [k]
...
if radheat
    t_form      = 1.5*yr*1e6;     % planetesimal formation time after CAI, recommend no more than 2 half lives
