...
RUN.ID          =  ['test_1_cold'];            % run identifier
...
SOL.T0      =  1250;                      % reference/top potential temperature [C]
...
PHY.aTFe        =  3e-5;                 % thermal expansivity iron [1/K]
...
NUM.abstol      = 1e-8;     % absolute residual tolerance for nonlinear iterations
