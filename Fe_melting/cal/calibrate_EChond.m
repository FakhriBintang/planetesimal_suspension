...
runID     = 'Phsdg_EC';     % run ID for output files; [system name_wt.% SiO2_wt.% H2O]
...
Liquidcompupper = load('./EC_Daniels_Kuil/Liquid_comp_upper.csv');   % output file of MELTS for upper phase loop
Solidcompupper  = load('./EC_Daniels_Kuil/Solid_comp_upper.csv');   % output file of MELTS for upper phase loop
Bulkcompupper   = load('./EC_Daniels_Kuil/Bulk_comp_upper.csv');   % output file of MELTS for upper phase loop

Liquidcomplower = load('./EC_Daniels_Kuil/Liquid_comp_lower.csv');   % output file of MELTS for upper phase loop
Solidcomplower  = load('./EC_Daniels_Kuil/Solid_comp_lower.csv');   % output file of MELTS for upper phase loop
Bulkcomplower   = load('./EC_Daniels_Kuil/Bulk_comp_lower.csv');   % output file of MELTS for upper phase loop
%% extract parameters
% upper phase loop
...
cphs0_bst  =  0.4226;               % phase diagram lower bound composition [wt SiO2]
cphs1_bst  =  0.784;               % phase diagram upper bound composition [wt SiO2]
Tphs0_bst  =  800;               % phase diagram lower bound temperature [degC]
Tphs1_bst  =  1850;                % phase diagram upper bound temperature [degC]
PhDg_bst   =  [20,10,1.0,0.93];  % Phase diagram curvature factor (> 1)
perCm_bst  =  0.66;               % peritectic liquidus composition [wt SiO2]
perCx_bst  =  0.64;               % peritectic solidus  composition [wt SiO2]
perT_bst   =  1140;                % peritectic temperature [degC]
